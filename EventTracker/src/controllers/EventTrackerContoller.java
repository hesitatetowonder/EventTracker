...
//	public Sleep create(@RequestBody String jsonQuiz, HttpServletResponse res) {
//		ObjectMapper mapper = new ObjectMapper();
//		try {
//			Sleep mappedQuiz = mapper.readValue(jsonSleeps, Sleep.class);
//			res.setStatus(201);
//			return eventDAO.create(mappedQuiz);
//		} catch (Exception e) {
//			e.printStackTrace();
//			return null;
//		}
